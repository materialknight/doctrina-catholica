...
[**1696**](#n1696) El camino de Cristo “lleva a la vida”, un camino contrario “lleva a la perdición” (Mt 7,13; cf Dt 30, 15-20). La parábola evangélica de *los dos caminos* está siempre presente en la catequesis de la Iglesia. Significa la importancia de las decisiones morales para nuestra salvación. “Hay dos caminos, el uno de la vida, el otro de la muerte; pero entre los dos, una gran diferencia” (*Didaché*, [1, 1]({{ "es/didache#c1-1" | relative_url }}))
{:#n1696}
...
<details class="details-1">
   ...
   {% include catechismus/es/p3-s1.html %}
</details>
...
<details class="details-1">
   ...
   {% include catechismus/es/p3-s2.html %}
</details>
